      ...
      <div className="container">
        <Reveal className="max-w-2xl">
          ...
          <p className="lede mt-5">
            Most practices hire these separately and end up with three vendors who never talk to
            each other. I bring them together, because strategy without execution is a document,
